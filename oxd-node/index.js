...
exports.register_site = function (request, callback) {
    ...
    if (request.url == "" || typeof request.url == 'undefined')
    {
        ...
        console.log(JSON.stringify(param));
        utilities.oxdHttpRequest(request.url, param, function (response) {
            callback(response);
        })
    }
...
exports.setup_client = function (request, callback) {
    var data = {};
    var param = {};
...
exports.get_client_access_token = function (request, callback) {
    var param = {};
    param.op_host = request.op_host;
    param.client_id = request.client_id;
    param.client_secret = request.client_secret;
...
exports.get_authorization_url = function (request, callback)
{
    ...
    param.custom_parameters = request.custom_parameters,
    param.protection_access_token = request.protection_access_token;
...
exports.get_access_token_by_refresh_token = function (request, callback) {
    var data = {};
    var param = {};
    param.oxd_id = request.oxd_id;
...
exports.uma_rp_get_claims_gathering_url = function (request, callback)
{
    var data = {};
    var param = {};
    param.oxd_id = request.oxd_id;
